// src/Zona/Zonacabai/Zona1cabai.jsx - Fixed Layout & CORS Error Handling
...
const Zona1cabai = () => {
  ...
  const [chartError, setChartError] = useState(null); // Separate chart error
      ...
      if (response && response.reading) {
        ...
        if (decoded) {
          ...
          setZoneData(prev => ({
            ...
            status: 'online' // Main data success = online
          }));
  ...
  const fetchChartData = async () => {
    try {
      ...
      // Chart error doesn't affect main status
  ...
  const handleRefresh = async () => {
    ...
    if (mainSuccess) {
      // Only fetch chart if main data succeeds
  ...
  return (
    <div className="zona1cabai-container">
      ...
      <div className="logo-container">
        ...
        {/* MOVED ZONE BADGE TO HEADER - BESIDE MENU */}
      ...
      <div className="header">
        ...
        <h1 className="page-title">CABAI ZONE 1 - MANUAL MODE</h1>
      ...
      <div className="main-content">
        ...
        {/* Content Area - REMOVED ZONE BADGE FROM HERE */}
      ...
      <div className="footer-bar">
        <div className="welcome-text">CABAI ZONE 1 - MANUAL REFRESH MODE</div>
      </div>
    </div>
  );
};
