...
const Zona5cabai = () => {
  ...
  return (
    <div className="zona5cabai-container">
      {/* Logo Container */}
      ...
      <div className="main-content">
        ...
        <div className="sidebar">
          ...
          <button className="zone-btn active" onClick={() => handleZoneClick('zona5')}>ZONA 5</button>
        ...
        <div className="content-area">
          ...
          <div className="zone-badge">
            <span className="zone-title">ZONE 5</span>
            ...
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  ...
                  />
                  <defs>
                    <linearGradient id="tempGradient5" x1="0%" y1="0%" x2="0%" y2="100%">
