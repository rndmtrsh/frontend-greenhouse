// src/Zona/Zonacabai/Zona3cabai.jsx - Zona 3 Cabai Component
...
const Zona3cabai = () => {
  ...
  const deviceCode = 'CZ3'; // DEVICE CODE ZONA 3
  ...
  return (
    <div className="zona1cabai-container">
      ...
      <div className="header">
        ...
        <h1 className="page-title">CABAI ZONE 3 - MANUAL MODE</h1>
            ...
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  ...
                  />
                  <defs>
                    <linearGradient id="tempGradient3" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      <div className="footer-bar">
        <div className="welcome-text">CABAI ZONE 3 - MANUAL REFRESH MODE</div>
      </div>
    </div>
  );
};

export default Zona3cabai;