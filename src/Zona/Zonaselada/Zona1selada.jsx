// ===========================================
// Zona1selada.jsx - Template untuk Extended Api.js
// ===========================================
...
const Zona1selada = () => {
  ...
  const [zoneData, setZoneData] = useState({
    ...
    metrics: {
      ...
      temperature: 0,
      tds: 0
      // TDS instead of EC for selada
    },
    chartData: {
      temperature: [],
      ph: [],
      tds: []
      // TDS chart instead of EC for selada
    },
    lastUpdated: null,
    status: 'offline',
    alerts: []
  ...
  const fetchZoneData = async () => {
    try {
      ...
      const [zoneResult, plantResult, alertsResult] = await Promise.all([
        apiService.getZoneData('selada', 1),
        apiService.getPlantInfo('selada'),
        apiService.getAlerts('selada', 1)
      ]);
  ...
  const fetchChartData = async (metric, timeRange = '24h') => {
    try {
      const chartData = await apiService.getChartData('selada', 1, metric, timeRange);
      setZoneData(prev => ({
        ...prev,
        chartData: {
          ...prev.chartData,
  ...
  return (
    <div className="zona1selada-container">
      {/* Logo Container */}
      ...
      <div className="main-content">
        ...
        <div className="content-area">
          ...
          {/* Monitoring Cards - 3 for selada (PH, Temperature, TDS) */}
          ...
          {/* Charts Section - 3 charts for selada (PH, Temperature, TDS) */}
            ...
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  ...
                  />
                  <defs>
                    <linearGradient id="tempGradientSelada1" x1="0%" y1="0%" x2="0%" y2="100%">
