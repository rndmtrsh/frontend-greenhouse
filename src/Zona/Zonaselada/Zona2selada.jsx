// ===========================================
// Zona2selada.jsx - Template untuk Extended Api.js
// ===========================================
...
const Zona2selada = () => {
  ...
  // Fetch data menggunakan extended API methods untuk ZONA 2
  const fetchZoneData = async () => {
    try {
      ...
      // Fetch zone data, plant info, dan alerts secara parallel untuk ZONA 2
      const [zoneResult, plantResult, alertsResult] = await Promise.all([
        apiService.getZoneData('selada', 2), // ZONA 2
        apiService.getPlantInfo('selada'),
        apiService.getAlerts('selada', 2) // ZONA 2
      ]);
  ...
  // Fetch chart data untuk specific metric ZONA 2
  const fetchChartData = async (metric, timeRange = '24h') => {
    try {
      const chartData = await apiService.getChartData('selada', 2, metric, timeRange); // ZONA 2
      setZoneData(prev => ({
        ...prev,
        chartData: {
          ...prev.chartData,
  ...
  // Auto-refresh data menggunakan subscription untuk ZONA 2
  useEffect(() => {
    // Initial fetch
    fetchZoneData();
    
    // Set up auto-refresh menggunakan subscription dari API untuk ZONA 2
  ...
  return (
    <div className="zona2selada-container">
      {/* Logo Container */}
            ...
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  ...
                  />
                  <defs>
                    <linearGradient id="tempGradientSelada2" x1="0%" y1="0%" x2="0%" y2="100%">
