          ...
          <div className="charts-section">
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  <path
                    d="M20,160 Q100,40 200,70 T380,130"
                    stroke="#4ade80"
                    strokeWidth="3"
                    fill="none"
                  />
                  ...
                  <path
                    d="M20,160 Q100,40 200,70 T380,130 L380,200 L20,200 Z"
            ...
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  <path
                    d="M20,150 Q100,60 200,90 T380,140"
                    stroke="#4ade80"
                    strokeWidth="3"
                    fill="none"
                  />
                  <path
                    d="M20,150 Q100,60 200,90 T380,140 L380,200 L20,200 Z"
                    fill="url(#tempGradientMelon1)"
                  />
                </svg>
                <div className="chart-time-labels">
            ...
            <div className="chart-container">
              ...
              <div className="chart">
                <svg viewBox="0 0 400 200" className="chart-svg">
                  <path
                    d="M20,170 Q100,80 200,110 T380,160"
                    stroke="#4ade80"
                    strokeWidth="3"
                    fill="none"
                  />
                  <path
                    d="M20,170 Q100,80 200,110 T380,160 L380,200 L20,200 Z"
                    fill="url(#tempGradientMelon1)"
                  />
                </svg>
                <div className="chart-time-labels">
