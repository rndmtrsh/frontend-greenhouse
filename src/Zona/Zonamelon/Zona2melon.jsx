// src/Zona/Zonamelon/Zona2melon.jsx - Zona 2 Melon dengan koneksi API
...
const Zona2melon = () => {
  ...
  // Info tanaman melon - sama dengan zona 1
  const [plantInfo] = useState({
    ...
    optimalConditions: {
      ...
      ec: { min: 1.5, max: 2.8, optimal: 2.2 },
      moisture: { min: 65, max: 85, optimal: 75 }
    }
  });

  // Device code untuk Zona 2 Melon
  const deviceCode = 'MZ2'; // Melon Zone 2
  ...
  return (
    <div className="zona2melon-container">
      ...
      <div className="header">
        ...
        <h1 className="page-title">MELON ZONE 2 - MANUAL MODE</h1>
      ...
      <div className="footer-bar">
        <div className="welcome-text">MELON ZONE 2 - MANUAL REFRESH MODE</div>
      </div>
    </div>
  );
};
